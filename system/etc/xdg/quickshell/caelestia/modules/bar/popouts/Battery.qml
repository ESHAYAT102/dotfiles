...
Column {
    ...
    StyledRect {
        ...
        implicitWidth: saver.implicitHeight + balance.implicitHeight + Tokens.padding.medium * 2 + Tokens.spacing.largeIncreased
        implicitHeight: Math.max(saver.implicitHeight, balance.implicitHeight) + Tokens.padding.small
    ...
    component Profile: Item {
        ...
        StateLayer {
            ...
            onClicked: Quickshell.execDetached(["/usr/bin/python3", "/usr/bin/powerprofilesctl", "set", parent.profileName])
        }
