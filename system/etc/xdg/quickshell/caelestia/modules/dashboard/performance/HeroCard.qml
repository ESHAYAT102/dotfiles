    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            MaterialIcon {
                ...
                // Arch's Material Symbols font lacks "thermometer_alert" and
                // renders its ligature name as text. The error colour below
                // still communicates the high-temperature state.
                text: "thermometer"
