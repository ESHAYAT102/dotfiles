...
Item {
    ...
    readonly property var currentList: showWallpapers ? wallpaperList.item : showUnlocks ? unlockList.item : appList.item
    property string animState: showWallpapers ? "wallpapers" : showUnlocks ? "unlocks" : "apps"
    ...
    states: [
        ...
        State {
            name: "unlocks"
            PropertyChanges {
                root.implicitWidth: Math.max(root.Tokens.sizes.launcher.itemWidth * 1.2, unlockList.implicitWidth)
                root.implicitHeight: root.Tokens.sizes.launcher.wallpaperHeight
                unlockList.active: true
            }
        }
    ]
    ...
    Row {
        ...
        MaterialIcon {
            text: root.state === "wallpapers" ? "wallpaper_slideshow" : root.state === "unlocks" ? "lock_open" : "manage_search"
