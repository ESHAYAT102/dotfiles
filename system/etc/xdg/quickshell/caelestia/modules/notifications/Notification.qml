    ...
    MouseArea {
        ...
        Item {
            ...
            Loader {
                ...
                anchors.left: parent.left
                anchors.top: parent.top
                width: root.mediaSize
                height: root.mediaSize
                ...
                sourceComponent: StyledClippingRect {
                    ...
                    implicitWidth: root.mediaSize
                    implicitHeight: root.mediaSize
                    ...
                    Image {
                        ...
                        sourceSize: {
                            const size = root.mediaSize * ((QsWindow.window as QsWindow)?.devicePixelRatio ?? 1);
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    radius: Tokens.rounding.full
                    color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.m3error : root.modelData.urgency === NotificationUrgency.Low ? Colours.layer(Colours.palette.m3surfaceContainerHighest, 2) : Colours.palette.m3secondaryContainer
                    implicitWidth: root.hasImage ? Tokens.sizes.notifs.badge : root.mediaSize
                    implicitHeight: root.hasImage ? Tokens.sizes.notifs.badge : root.mediaSize
