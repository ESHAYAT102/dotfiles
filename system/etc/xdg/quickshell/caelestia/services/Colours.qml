...
Singleton {
    ...
    // This desktop profile is dark-only. Do not let wallpaper previews or a
    // stale scheme transition switch the live shell back to its light palette.
    ...
    function setMode(mode: string): void {
        // The local desktop profile is deliberately dark-only.
