...
//
// Built on PanelWindow with on-demand layer-shell keyboard focus rather than
// PopupWindow (xdg-popup). On-demand focus keeps keyboard interaction
// available without monopolizing focus across workspace switches.
//
