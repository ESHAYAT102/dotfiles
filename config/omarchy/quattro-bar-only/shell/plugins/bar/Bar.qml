...
Item {
  ...
  IpcHandler {
    target: "omarchy.bar"
    function closePopout(): void { root.closeActivePopout() }
  }
  ...
  onActivePopoutChanged: Qt.callLater(root.syncEscapeBinding)
  ...
  Component.onDestruction: Quickshell.execDetached(["hyprctl", "keyword", "unbind", ", ESCAPE"])
