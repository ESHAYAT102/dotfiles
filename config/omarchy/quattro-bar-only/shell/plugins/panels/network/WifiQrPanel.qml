  ...
  BorderSurface {
    ...
    Item {
      ...
      ColumnLayout {
        ...
        Rectangle {
          id: qrCanvas
          readonly property int moduleSize: root.qrSize > 0 ? Math.max(4, Math.floor(Style.space(240) / root.qrSize)) : 0
        ...
        Text { visible: root.loading; text: "Generating QR code…"; color: root.bar.foreground; Layout.fillWidth: true; horizontalAlignment: Text.AlignHCenter }
        Text { visible: root.error !== ""; text: root.error; color: root.bar.urgent; wrapMode: Text.Wrap; Layout.fillWidth: true; horizontalAlignment: Text.AlignHCenter }
        Text { visible: root.showingQr; text: "Scan to join this network"; color: root.bar.foreground; Layout.fillWidth: true; horizontalAlignment: Text.AlignHCenter }
        ...
        Text {
          ...
          Layout.fillWidth: true
          horizontalAlignment: Text.AlignHCenter
          MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: root.passwordToggleRequested() }
        }
      }
    }
  }
