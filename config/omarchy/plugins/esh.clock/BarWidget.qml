...
// click on a clock means — middle click opens the timezone picker.
BarWidget {
  id: root
  moduleName: "esh.clock"
  ...
  // Keep the configured format as the single source of truth for the label.
