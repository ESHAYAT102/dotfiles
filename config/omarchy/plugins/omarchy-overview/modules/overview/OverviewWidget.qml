...
Item {
    ...
    property color activeBorderColor: ColorUtils.applyAlpha(Color.launcher.selectedText, 0.55)
    property color workspaceCursorFill: Color.launcher.selectedBackground
    property color workspaceHoverFill: ColorUtils.applyAlpha(Color.launcher.selectedText, 0.045)
    ...
    property real scaledWorkspaceSpacing: Style.spaceReal(workspaceSpacing)
    ...
    readonly property real specialStripGap: scaledWorkspaceSpacing * 1.8
    readonly property real specialStripPadding: Style.spacing.popupPadding
    readonly property real specialStripTitleHeight: Style.font.subtitle
    readonly property real specialStripTitleGap: Style.spacing.md
    readonly property real specialTileLabelHeight: Math.max(Style.spacing.controlHeight, Style.font.bodySmall + Style.spacing.controlPaddingY * 2)
    readonly property real specialTileLabelPadding: Style.spacing.controlPaddingX
    readonly property color specialPanelFill: Color.launcher.background
    readonly property color specialTileFill: "transparent"
    readonly property color specialTileHoverFill: Color.launcher.selectedBackground
    readonly property color specialDropFill: Color.launcher.selectedBackground
    ...
    readonly property real specialWorkspaceTileWidth: {
        ...
        const rawWidth = (root.specialGridInnerWidth - gaps * root.scaledWorkspaceSpacing) / root.effectiveSpecialColumns;
    ...
    readonly property real specialGridUsedWidth: root.effectiveSpecialColumns * root.specialWorkspaceTileWidth + Math.max(0, root.effectiveSpecialColumns - 1) * root.scaledWorkspaceSpacing
    ...
    readonly property real specialStripTop: workspaceColumnLayout.implicitHeight + root.scaledWorkspaceSpacing + root.specialStripGap
    ...
    readonly property real specialGridHeight: root.specialWorkspaceRows * root.specialWorkspaceTileHeight + Math.max(0, root.specialWorkspaceRows - 1) * root.scaledWorkspaceSpacing
    ...
    function compactWorkspaceRow(rowIndex) {
        if (!Config.options.overview.hideEmptyRows || !root.rowsWithContent)
            return rowIndex;

        let compactIndex = 0;
        for (let i = 0; i < rowIndex; i++) {
            if (root.rowsWithContent.has(i))
                compactIndex += 1;
        }
        return compactIndex;
    }
    ...
    Rectangle { // Background
        ...
        implicitWidth: contentLayout.implicitWidth + Style.spaceReal(padding) * 2
        implicitHeight: contentLayout.implicitHeight + Style.spaceReal(padding) * 2
        ...
        ColumnLayout { // Workspaces
            ...
            spacing: root.scaledWorkspaceSpacing
            ColumnLayout {
                ...
                Repeater {
                    ...
                    Repeater { // Workspace repeater
                        ...
                        Rectangle { // Workspace
                            ...
                            property bool hasWindows: root.workspaceHasWindows(workspaceValue)
                            property color defaultWorkspaceColor: "transparent"
                            property color hoveredWorkspaceColor: root.workspaceHoverFill
                            property color hoveredBorderColor: root.activeBorderColor
                            property bool hoveredWhileDragging: false

                            implicitWidth: root.workspaceImplicitWidth
                            implicitHeight: root.workspaceImplicitHeight
                            color: (showWallpaper || (!root.workspaceHasWindows(workspaceValue) && !hoveredWhileDragging))
                                ? "transparent"
                                : (hoveredWhileDragging ? hoveredWorkspaceColor : defaultWorkspaceColor)
                            radius: Style.cornerRadius
                            border.width: hoveredWhileDragging ? Math.max(1, Style.space(1)) : 0
                            ...
                            Rectangle {
                                ...
                                color: ColorUtils.applyAlpha(
                                    ...
                                    workspace.hoveredWhileDragging
                                        ? Math.min(0.20, root.emptyWorkspaceWallpaperOverlayOpacity + 0.06)
                            ...
                            StyledText {
                                ...
                                color: ColorUtils.applyAlpha(Color.launcher.text, 0.28)
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Grid {
                        ...
                        rowSpacing: root.scaledWorkspaceSpacing
                        columnSpacing: root.scaledWorkspaceSpacing
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                property bool hovered: specialWorkspaceMouseArea.containsMouse
                                property bool dropTarget: root.draggingTargetSpecialWorkspace === specialName
                                property color baseColor: root.specialTileFill
                                ...
                                color: showWallpaper
                                    ? "transparent"
                                    : (dropTarget ? root.specialDropFill : (hovered ? root.specialTileHoverFill : baseColor))
                                border.width: dropTarget ? Math.max(1, Style.space(2)) : Style.controlBorderWidth(false, hovered)
                                border.color: dropTarget
                                    ? root.activeBorderColor
                                    : Style.controlBorder(false, hovered, Color.foreground, Color.accent)
                                ...
                                Rectangle {
                                    ...
                                    radius: parent.radius
                                    color: ColorUtils.applyAlpha(
                                        specialWorkspaceTile.dropTarget
                                            ? root.specialDropFill
                                            : (specialWorkspaceTile.hovered ? root.specialTileHoverFill : specialWorkspaceTile.baseColor),
                                        specialWorkspaceTile.dropTarget
                                            ? Math.min(0.42, root.emptyWorkspaceWallpaperOverlayOpacity + 0.18)
                                            : (specialWorkspaceTile.hovered
                                                ? Math.min(0.34, root.emptyWorkspaceWallpaperOverlayOpacity + 0.10)
                                                : root.emptyWorkspaceWallpaperOverlayOpacity)
                                    )
                                }
                                ...
                                Rectangle {
                                    ...
                                    z: 2
                                    height: root.specialTileLabelHeight
                                    radius: parent.radius
                                    color: Color.launcher.background
                                    ...
                                    Rectangle {
                                        ...
                                        color: Color.launcher.border
                                    }

                                    StyledText {
                                        anchors.fill: parent
                                        anchors.leftMargin: root.specialTileLabelPadding
                                        anchors.rightMargin: root.specialTileLabelPadding
                                        text: root.specialWorkspaceLabel(specialWorkspaceTile.specialName)
                        ...
                        Rectangle {
                            ...
                            property bool showWallpaper: root.hasSpecialEmptyWorkspaceWallpaper
                            property bool hovered: createSpecialWorkspaceMouseArea.containsMouse
                            property bool dropTarget: root.draggingTargetSpecialWorkspace === root.createSpecialWorkspaceTarget
                            implicitWidth: root.specialWorkspaceTileWidth
                            implicitHeight: root.specialWorkspaceTileHeight
                            radius: Style.cornerRadius
                            color: showWallpaper ? "transparent" : ColorUtils.applyAlpha(
                                dropTarget ? root.specialDropFill : (hovered ? root.specialTileHoverFill : root.specialTileFill),
                                1
                            )
                            border.width: dropTarget ? Math.max(1, Style.space(2)) : Style.controlBorderWidth(false, hovered)
                            border.color: dropTarget
                            ...
                            Rectangle {
                                ...
                                radius: parent.radius
                                color: ColorUtils.applyAlpha(
                                    createSpecialWorkspaceTile.dropTarget ? root.specialDropFill : (createSpecialWorkspaceTile.hovered ? root.specialTileHoverFill : root.specialTileFill),
                                    createSpecialWorkspaceTile.dropTarget
                                        ? Math.min(0.28, root.emptyWorkspaceWallpaperOverlayOpacity + 0.08)
                                        : (createSpecialWorkspaceTile.hovered
                                            ? Math.min(0.34, root.emptyWorkspaceWallpaperOverlayOpacity + 0.10)
                                            : root.emptyWorkspaceWallpaperOverlayOpacity)
                                )
                            }
                            ...
                            Column {
                                ...
                                StyledText {
                                    ...
                                    visible: !createSpecialWorkspaceTile.showWallpaper
                                    text: createSpecialWorkspaceTile.dropTarget ? "Release" : "+"
                                    font.family: Style.font.family
                                    font.pixelSize: createSpecialWorkspaceTile.dropTarget
                                        ? Style.font.title
                                        : Style.font.displayLarge
                                    font.weight: Font.DemiBold
                                    color: ColorUtils.applyAlpha(Color.foreground, 0.92)
                                    horizontalAlignment: Text.AlignHCenter
                                }
                                ...
                                StyledText {
                                    ...
                                    font.family: Style.font.family
                                    font.pixelSize: Style.font.bodySmall
                                    color: ColorUtils.applyAlpha(Color.foreground, 0.72)
                                    horizontalAlignment: Text.AlignHCenter
                                }
                            }

                            MouseArea {
                                id: createSpecialWorkspaceMouseArea
                                anchors.fill: parent
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                acceptedButtons: Qt.LeftButton
        ...
        Item { // Windows & focused workspace indicator
            ...
            Repeater { // Window repeater
                ...
                delegate: OverviewWindow {
                    ...
                    xOffset: (root.workspaceImplicitWidth + root.scaledWorkspaceSpacing) * workspaceColIndex
                    yOffset: (root.workspaceImplicitHeight + root.scaledWorkspaceSpacing) * root.compactWorkspaceRow(workspaceRowIndex)
            ...
            Rectangle { // Focused workspace indicator
                ...
                x: (root.workspaceImplicitWidth + root.scaledWorkspaceSpacing) * activeWorkspaceColIndex
                y: (root.workspaceImplicitHeight + root.scaledWorkspaceSpacing) * root.compactWorkspaceRow(activeWorkspaceRowIndex)
                z: root.windowDraggingZ - 1
                width: root.workspaceImplicitWidth
                height: root.workspaceImplicitHeight
                color: root.workspaceCursorFill
                radius: Style.cornerRadius
