...
o.window({ title = "^(Library|File Upload|Open File|Save File|Select a Folder|Open Folder|Upload(.*)|Save As|Select File|Select Folder|Choose File|Sign in - Google Accounts — Zen Browser|Task Manager - Brave).*$" }, {
  float = true,
  size = { 700, 500 },
  center = true,
})
